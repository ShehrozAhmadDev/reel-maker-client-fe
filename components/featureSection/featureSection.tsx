...
const FeatureSection = () => {
  return (
    <section className="w-full py-24 bg-gradient-to-r from-purple-500 to-blue-500">
      <div className="container mx-auto text-center">
        <div className="max-w-[60%] mx-auto">
          ...
          <p className="text-lg mb-8 text-gray-300">
            ...
            their videos and subscribe to plans. Our team of professionals will
            edit your videos and create stunning reels for you.
          </p>
        </div>
